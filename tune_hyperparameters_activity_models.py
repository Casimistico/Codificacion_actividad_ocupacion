        ...
        for second in range(10):
            for third in range(10):
                ...
                if len(select['Cuarta'].unique())>1:
                    ...
                    df_eval = parameter_search(select,'TEXTO_ACTIVIDAD', 'Cuarta',df_eval,index)
    ...
    for first in range(10):
        for second in range(10):
            ...
            if len(select['Tercera'].unique())>1:
                ...
                df_eval = parameter_search(select,'TEXTO_ACTIVIDAD', 'Tercera',df_eval,index)
    return df_eval
...
def parameter_eval_first_layer(df,df_eval):
    for first in range(10):
        ...
        if len(select['Segunda'].unique())>1:
            index = str(first) 
            df_eval = parameter_search(select,'TEXTO_ACTIVIDAD', 'Segunda', df_eval, index)
    return df_eval
